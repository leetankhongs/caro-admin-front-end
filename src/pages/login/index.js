...
import CustomizedSnackbars from './../../components/CustomizedSnackbars/index'
...
export default function SignIn(props) {
    ...
    return (
        <Container component="main" maxWidth="xs"  >
            <CustomizedSnackbars pIsOpen={error}
                pType='error'
                pMesssage='Error'
                onClose={
                    () => setError(false)
            ...
            <div className={classes.paper} >
                ...
                {/* <Grid container justify="space-between">
                    ...
                    <Grid item>
                        <GoogleLogin
                            clientId="232820745840-6dqvfu62hhrb710a8m6j8pjh6klg40pc.apps.googleusercontent.com"
                            buttonText="Google"
